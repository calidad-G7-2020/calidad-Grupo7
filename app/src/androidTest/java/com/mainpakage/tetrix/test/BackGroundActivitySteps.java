...
public class BackGroundActivitySteps {
    ...
    public void im_in_the_menu_of_the_game_and_i_want_to_change_background_color() throws Throwable {
        throw new PendingException();
    }

    @When("^I select the background in select bar$")
    public void i_select_the_background_in_select_bar() throws Throwable {
        throw new PendingException();
    }

    @Then("^ I change the background color$")
    public void i_change_the_background_color() throws Throwable {
        throw new PendingException();
    }
